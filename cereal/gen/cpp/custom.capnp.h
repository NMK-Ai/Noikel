...
struct NullControlsState {
  NullControlsState() = delete;
...
class NullControlsState::Reader {
public:
  typedef NullControlsState Reads;
...
class NullControlsState::Builder {
public:
  typedef NullControlsState Builds;
...
#if !CAPNP_LITE
class NullControlsState::Pipeline {
public:
  typedef NullControlsState Pipelines;
...
inline bool NullControlsState::Reader::getAlkaActive() const {
  return _reader.getDataField<bool>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS);
}

inline bool NullControlsState::Builder::getAlkaActive() {
  return _builder.getDataField<bool>(
      ::capnp::bounded<0>() * ::capnp::ELEMENTS);
}
inline void NullControlsState::Builder::setAlkaActive(bool value) {
