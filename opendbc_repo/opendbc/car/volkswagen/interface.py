...
class CarInterface(CarInterfaceBase):
  ...
  @staticmethod
  def _get_params(ret: structs.CarParams, candidate: CAR, fingerprint, car_fw, experimental_long, null_params, docs) -> structs.CarParams:
    ...
    if null_params & structs.NullFlags.VagA0SnG:
