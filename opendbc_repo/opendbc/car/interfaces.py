...
class CarInterfaceBase(ABC):
  ...
  def get_params(cls, candidate: str, fingerprint: dict[int, dict[int, int]], car_fw: list[structs.CarParams.CarFw],
                 experimental_long: bool, null_params: int, docs: bool) -> structs.CarParams:
    ...
    ret = cls._get_params(ret, candidate, fingerprint, car_fw, experimental_long, null_params, docs)
  ...
  def _get_params(ret: structs.CarParams, candidate, fingerprint: dict[int, dict[int, int]],
                  car_fw: list[structs.CarParams.CarFw], experimental_long: bool, null_params: int, docs: bool) -> structs.CarParams:
