...
class Controls:
  def __init__(self) -> None:
    ...
    self.pm = messaging.PubMaster(['carControl', 'controlsState', 'nullControlsState'])
    ...
    self.alka_enabled = self.params.get_bool("null_lateral_alka")
  ...
  def publish(self, CC, lac_log):
    ...
    # nullControlsState
    dat = messaging.new_message('nullControlsState')
    dat.valid = True
    ncs = dat.nullControlsState
    ncs.alkaActive = self.alka_active
    self.pm.send('nullControlsState', dat)
